...
class RegisterRequest(BaseModel):
    """Schema cho request đăng ký - cho phép đăng ký chỉ với số điện thoại và mật khẩu"""
    email: Optional[str] = Field(None, description="Email đăng ký (tuỳ chọn)")
    ...
    customId: Optional[str] = Field(None, description="ID/Username tùy chỉnh của khách hàng", max_length=50)
