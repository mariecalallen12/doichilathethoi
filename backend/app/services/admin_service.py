...
# from ..models.trading import TradingOrder, PortfolioPosition  # Removed - trading models don't exist
...
class AdminService:
    ...
    def get_platform_stats(self) -> Dict[str, Any]:
        ...
        # Trading stats
        # TradingOrder model removed - commenting out
    ...
    def get_user_performance(self, user_id: int) -> Dict[str, Any]:
        ...
        # Trading stats - TradingOrder model removed
        ...
        # Position stats - PortfolioPosition model removed
