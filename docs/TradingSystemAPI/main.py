...
from websocket_streams import ws_router
...
main_app.include_router(ws_router, prefix="/ws", tags=["WebSocket Streams"])
main_app.include_router(control_router, prefix="/admin/market-control", tags=["Admin Market Control"])
